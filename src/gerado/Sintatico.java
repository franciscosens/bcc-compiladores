...
public class Sintatico implements Constants {
    ...
    private boolean step() throws LexicalError, SyntaticError, SemanticError {
        ...
        int start = currentToken.getPosition() - currentToken.getLexeme().length();
        ...
        if (x == EPSILON) {
            ...
            if (x == a) {
                ...
                throw new SyntaticError(Utilitario.retornarTextoErroLinha(start, scanner.getInput()) + PARSER_ERROR[x], currentToken.getPosition());
            }
